...
// declare the vao variables for game objects
VAO *ground, *groundline, *polygon;
...
void createPolygon (float radius, int sides)
{
  ...
  GLfloat previous[3] = {0.0, 0.0, 0.0};  // previously computed vertex
  ...
  polygon = create3DObject(GL_TRIANGLES, sides * 3, vertex_buffer_data, color_buffer_data, GL_FILL);
}
...
void drawGround()
{
  ...
  glm::mat4 translateRectangle = glm::translate (glm::vec3(0, -3.0f, 0));        // glTranslatef
